...
namespace rosette_api
{
    ...
    public class SentimentResponse : RosetteResponse
    {
        ...
        public SentimentResponse(HttpResponseMessage apiResult) :base(apiResult)
        {
            ...
            foreach (Object result in enumerableResults)
            {
                ...
                entitySentiments.Add(SentimentResponse.CreateEntity(type, mention, entityID, sentiment, confidence));
            }
        ...
        public static RosetteSentimentEntity CreateEntity(String entityType, String mention, EntityID id, String sentiment, Nullable<double> confidence)
        {
            switch (entityType)
            {
                case RosetteEntity.LOCATION: return new RosetteSentimentEntity.RosetteLocation(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.ORGANIZATION: return new RosetteSentimentEntity.RosetteOrganization(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.PERSON: return new RosetteSentimentEntity.RosettePerson(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.PRODUCT: return new RosetteSentimentEntity.RosetteProduct(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.TITLE: return new RosetteSentimentEntity.RosetteTitle(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.NATIONALITY: return new RosetteSentimentEntity.RosetteNationality(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.RELIGION: return new RosetteSentimentEntity.RosetteReligion(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.CREDIT_CARD_NUM: return new RosetteSentimentEntity.RosetteCreditCardNum(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.EMAIL: return new RosetteSentimentEntity.RosetteEmailAddress(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.MONEY: return new RosetteSentimentEntity.RosetteMoney(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.PERSONAL_ID_NUM: return new RosetteSentimentEntity.RosettePersonalIDNumber(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.PHONE_NUMBER: return new RosetteSentimentEntity.RosettePhoneNumber(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.URL: return new RosetteSentimentEntity.RosetteURL(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.DATE: return new RosetteSentimentEntity.RosetteDate(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.TIME: return new RosetteSentimentEntity.RosetteTime(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.DISTANCE: return new RosetteSentimentEntity.RosetteDistance(mention, id, entityType, sentiment, confidence);
                case RosetteEntity.LATITUDE_LONGITUDE: return new RosetteSentimentEntity.RosetteLatLong(mention, id, entityType, sentiment, confidence);
                default: return new RosetteSentimentEntity(mention, id, entityType, sentiment, confidence);
            }
        }
    }
    ...
    public class RosetteSentimentEntity : RosetteEntity
    {
        ...
        /// </summary>
        public SentimentResponse.RosetteSentiment Sentiment;
        ...
        public RosetteSentimentEntity(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType)
        {
        ...
        public class RosetteLocation : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteLocation(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteDistance : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteDistance(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteLatLong : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteLatLong(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosettePerson : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosettePerson(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteOrganization : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteOrganization(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteTitle : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteTitle(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteCreditCardNum : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteCreditCardNum(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteProduct : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteProduct(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteNationality : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteNationality(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteReligion : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteReligion(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteEmailAddress : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteEmailAddress(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteMoney : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteMoney(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosettePersonalIDNumber : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosettePersonalIDNumber(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosettePhoneNumber : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosettePhoneNumber(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteURL : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteURL(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteDate : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteDate(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
        ...
        public class RosetteTime : RosetteSentimentEntity
        {
            ...
            /// <param name="sentiment">The contextual sentiment of the entity</param>
            /// <param name="confidence">The confidence that the sentiment was correctly identified</param>
            public RosetteTime(String mention, EntityID id, String entityType, String sentiment, Nullable<double> confidence) : base(mention, id, entityType, sentiment, confidence) { }
        }
    }
}
